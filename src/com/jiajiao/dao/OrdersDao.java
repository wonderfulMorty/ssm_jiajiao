...
public interface OrdersDao {
	...
	public List<Orders> pagefindOrdersList(@Param("course")String course, @Param("areaId")String areaId,
			@Param("teacherType")int teacherType, @Param("gender")int gender,
			@Param("pageSize")int pageSize, @Param("currentPage")int currentPage);

	public int pagefindOrdersListCout(@Param("course")String course, @Param("areaId")String areaId,
			@Param("teacherType")int teacherType, @Param("gender")int gender);
	...
	public List<Orders> pagefindOrderListByCondition(@Param("courseId")int courseId, @Param("areaId")int areaId,
			@Param("teacherType")int teacherType, @Param("gender")int gender, 
			@Param("pageSize")int pageSize, @Param("currentPage")int currentPage);
